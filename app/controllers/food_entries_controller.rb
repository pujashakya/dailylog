...
# byebug
#     @food_type=FoodType.find(@food_entries.food_type_id)
# byebug
  end
  ...
  def create
    ...
    respond_to do |format|
      if @food_entry.save
        ...
        # format.json { render :index, status: :created, location: @food_entry }
        format.html { redirect_to action: "index", notice: 'Food entry was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @food_entry.update(food_entry_params)
        ...
        # format.json { render :index, status: :ok, location: @food_entry }
        format.html { redirect_to action: "index", notice: 'Food entry was successfully created.' }
      else
  ...
  private
    ...
    def food_entry_params
      params.require(:food_entry).permit(:fed_date, :amount, :notes, :food_type, :food_type_id)
    end
end
